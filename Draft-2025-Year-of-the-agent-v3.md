...
The conversation drifted to the old Manitoba VMUG - the VMware User Group that used to bring infrastructure people together. Sure, there were vendor presentations that is how it was paid for, but they were technical deep-dives, and the real value was practitioners showing what actually worked in production and sharing honest war stories.
...
One of the clearest signals that reality of agents is not a rosy as the headlines lead us to beleive is the language shift over the last 18 months. We've quietly walked back the boldest words:
