...
A man in a black velvet jacket with a working Star Trek communicator pin just gave Wally the sentence of the conference. He'd been running a local inference demo on what looked like fourteen thousand dollars of NVIDIA silicon under a lectern at the RBC Convention Centre — a voice clone, a face clone, all of it offline, all of it portable, all of it the kind of thing a reasonable person used to believe needed a data centre. And then, between slides, he dropped it:
