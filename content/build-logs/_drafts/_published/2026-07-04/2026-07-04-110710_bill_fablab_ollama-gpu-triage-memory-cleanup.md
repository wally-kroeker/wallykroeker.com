...
**What we worked on:**
- Diagnosed CPU-only inference on litellm-ollama (walub, 10.10.10.100:11435) — confirmed via SSH, docker inspect, and log inspection
