export const site = {
  ...
  discord: process.env.DISCORD_INVITE ?? 'https://discord.gg/uvWH2rNwC5',
  ...
  email: process.env.EMAIL ?? 'mailto:hello@wallykroeker.com',
  calendar: process.env.CALENDAR_URL ?? 'https://calendar.google.com/calendar/u/0/r?cid=YOUR_CALENDAR',
}
