...
- Built `~/.claude/tools/Tailscale.ts` — full API management tool with Infisical secret retrieval
- Created `~/.claude/skills/Bob/Tailscale/SKILL.md` and registered in parent skill index
- Updated Tailscale ACL: all `tag:Personal` devices now have Mullvad access, removed stale entries
- Wrote `docs/tailscale-network.md` — complete FabLab Tailscale + Mullvad documentation
- Updated FabLab CLAUDE.md with Tailscale/Mullvad external access section
